const keysFlute = () => {
    const keySetup = `
        <div class="key-item key-lower">
            <svg id="key-th-bflat" height="63" width="18">
                <rect x="6" y="25" height="10" width="10" stroke="silver" stroke-width="2" fill="none" />
                Sorry, your browser does not support inline SVG.  
            </svg>
        </div>
        <div class="key-item key-lower">
            <svg id="key-th" height="63" width="28">
                <rect x="1" y="25" height="10" width="20" stroke="silver" stroke-width="2" fill="none" />
                Sorry, your browser does not support inline SVG.
            </svg>
        </div>
        <div class="key-item">
            <svg id="key-lh-1" height="40" width="40">
                <circle cx="20" cy="20" r="15" stroke="silver" stroke-width="3" fill="none" />
                Sorry, your browser does not support inline SVG.
            </svg>
        </div>
        <div class="key-item">
            <svg id="key-lh-2" height="40" width="40">
                <circle cx="20" cy="20" r="15" stroke="silver" stroke-width="3" fill="none" />
                Sorry, your browser does not support inline SVG.
            </svg>
        </div>
        <div class="key-item">
            <svg id="key-lh-3" height="40" width="40">
                <circle cx="20" cy="20" r="15" stroke="silver" stroke-width="3" fill="none" />
                Sorry, your browser does not support inline SVG.
            </svg>
        </div>
        <div class="key-item">
            <svg id="key-lh-4" height="60" width="40">
            <path d="M 10 10 h 20 v 40 h -5 v -28 h -15 v -12" stroke="silver" stroke-width="3" fill="none" />
            Sorry, your browser does not support inline SVG.
            </svg>
        </div>
        <div class="key-item">
            <svg id="key-rh-1" height="40" width="40">
                <circle cx="20" cy="20" r="15" stroke="silver" stroke-width="3" fill="none" />
                Sorry, your browser does not support inline SVG.
            </svg>
        </div>
        <div class="key-item key-lower">
            <svg id="key-rh-tr1" height="63" width="18">
                <ellipse cx="9" cy="24" rx="5" ry="12" stroke="silver" stroke-width="2" fill="none" />
                Sorry, your browser does not support inline SVG.
            </svg>
        </div>
        <div class="key-item">
            <svg id="key-rh-2" height="40" width="40">
                <circle cx="20" cy="20" r="15" stroke="silver" stroke-width="3" fill="none" />
                Sorry, your browser does not support inline SVG.
            </svg>
        </div>
        <div class="key-item key-lower">
            <svg id="key-rh-tr2" height="63" width="18">
                <ellipse cx="9" cy="24" rx="5" ry="12" stroke="silver" stroke-width="2" fill="none" />
                Sorry, your browser does not support inline SVG.
            </svg>
        </div>
        <div class="key-item">
            <svg id="key-rh-3" height="40" width="40">
                <circle cx="20" cy="20" r="15" stroke="silver" stroke-width="3" fill="none" />
                Sorry, your browser does not support inline SVG.
            </svg>
        </div>
        <div class="key-item">
            <svg id="key-rh-pinky" height="40" width="24">
        ...
        <div>
            <div class="key-item key-item-roller">
                <svg id="key-rh-broll" height="8" width="22">
                    <rect x="1" y="1" height="6" width="20" stroke="silver" stroke-width="2" fill="none" />
                    Sorry, your browser does not support inline SVG.
                </svg>
                <svg id="key-rh-croll" height="8" width="22">
                    <rect x="1" y="1" height="6" width="20" stroke="silver" stroke-width="2" fill="none" />
                    Sorry, your browser does not support inline SVG.
                </svg>
            </div>
            <div class="key-item">
                <svg id="key-rh-csharp" height="20" width="28">
...
// [id].firstElementChild.style.fill